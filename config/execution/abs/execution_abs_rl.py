...
parser.add_argument('--direction', default=None,
                    help='BUY or SELL')
parser.add_argument('--parent_qty', type=int, default=None,
                    help='Total Size of the parent order')
parser.add_argument('--start_hour', type=int, default=None,
                    help='Time (in hours) to start executing the parent order')
parser.add_argument('--horizon_length', type=int, default=None,
                    help='Length of the execution time horizon (in minutes)')
parser.add_argument('--freq', default=None,
                    help='Frequency of Order Placement')

parser.add_argument('-f', '--fundamental-file-path', required=True,
                    help="Path to external fundamental file.")

parser.add_argument('-m', '--mode', default=None,
                    help='train (collect experiences) or test (use the Q-table)')
parser.add_argument('-a', '--agent_type', default=None,
                    help='baseline or rl agent')

parser.add_argument('-q', '--q_table', default=None,
                    help='Q Table file')
...
if args.agent_type == 'rl':
    ...
    q_learning_agent = QLearningTWAPAgent(id=agent_count,
